        ...
        <>
            <div className="flex flex-wrap flex-col gap-[20px] items-center justify-center w-[90%] m-[0_auto] text-[var(--text-main)]">
                ...
                <div className="mb-[20px] text-center flex flex-col justify-center items-center gap-[10px]">
                    ...
                    <p className="text-[20px] text-[var(--text-muted)]">è arrivato il momento di metterti alla prova da una singola app, sarete tu contro il tuo amico in una sfida di piegamenti, trazioni o squat!<br /><span className="text-[var(--text-secondary)]">Sei sicuro di poter vincere tu?</span></p>
                    ...
                    <button className="w-[100%] md:w-[300px] text-[20px] text-[var(--bg-main)] bg-[var(--text-secondary)] p-[10px] border-[1px] border-[var(--text-secondary)] rounded-[10px] hover:bg-[var(--bg-main)] hover:text-[var(--text-secondary)] duration-[400ms] transition-all mt-[20px]">Accedi ora all'App</button>
                </div>
                ...
                <div className="mb-[20px] text-center flex flex-col justify-center items-center gap-[10px]">
                    ...
                    <p className="text-[20px] text-[var(--text-muted)]">Sono una singola persona a dire la verità, mi presento! Sono Mattia De Vincentis, ho 21 anni e sono appassionato sia di informatica che di palestra, così ho deciso di fondere le due cose assieme e creare una webapp che potesse farmi e farvi divertire con i vostri amici!</p>
                </div>

                <div className="mb-[20px] text-center flex flex-col justify-center items-center gap-[10px]">
                    <h1 className="text-[30px] text-[var(--text-main)]">Perché fitness game?</h1>
                    <p className="text-[20px] text-[var(--text-muted)]">Beh semplice no? la palestra farla singolarmente si ti sprona ma ti diverte tanto quanto farla con un tuo amico? e diciamoci la verità, alla fine cerchi sempre di essere il migliore quindi ecco fuse le due realtà!</p>
                </div>

                <div className="mb-[20px] text-center flex flex-col justify-center items-center gap-[10px]">
                    <h1 className="text-[30px] text-[var(--text-main)]">Ecco come funziona</h1>
                    <p className="text-[20px] text-[var(--text-muted)]">Dovrai inserire il livello di difficoltà e poi devi scegliere se fare la sfida full che comprende squat, piegamenti e trazioni o la sfida normale, cioè scegli te la categoria che preferisci. Vorrei poter vedere chi tra di voi vince la sfida, ah cavolo quasi mi scordavo! occhio al livello che inserite perché potrebbe succedere che appare pure un timer :)</p>
                </div>

                <div className="mb-[20px] text-center flex flex-col justify-center items-center gap-[10px]">
                    <h1 className="text-[30px] text-[var(--text-main)]">Cosa non ti ha ancora convinto?</h1>
                    <p className="text-[20px] text-[var(--text-muted)]">Forse sono sembrato troppo cattivo e frettoloso mannaggia! e se te lo chiedessi tipo perfavore? sennò mi licenzio da solo uff :(</p>
                    <button className="w-[100%] md:w-[300px] text-[20px] text-[var(--primary)] bg-[var(--bg-main)] p-[10px] border-[1px] border-[var(--primary)] rounded-[10px] hover:bg-[var(--primary)] hover:text-[var(--bg-main)] duration-[400ms] transition-all mt-[20px]">Dai clicca qui perfavore :(</button>
                </div>
            </div>
        </>
    )
