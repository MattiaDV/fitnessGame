        ...
        <>
            <div className="flex flex-wrap flex-col gap-[20px] items-center justify-center w-[90%] m-[0_auto] text-[var(--text-main)]">
                ...
                <div className="mb-[20px] text-center flex flex-col justify-center items-center gap-[10px] w-full">
                    ...
                    <button onClick={redirectToGame} className="w-[100%] md:w-[300px] text-[20px] text-[var(--primary)] bg-[var(--bg-main)] p-[10px] border-[1px] border-[var(--primary)] rounded-[10px] hover:bg-[var(--primary)] hover:text-[var(--bg-main)] duration-[400ms] transition-all mt-[20px]">Accedi ora all'App</button>
                </div>
